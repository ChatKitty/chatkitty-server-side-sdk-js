...
export const ChannelApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getChannelMessages(id: number, page?: number, size?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagePage>> {
...
export const ChannelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getChannelMessages(id: number, page?: number, size?: number, options?: any): AxiosPromise<MessagePage> {
