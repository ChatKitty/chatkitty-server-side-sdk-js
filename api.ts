...
export interface Reaction {
    ...
    emoji: Emoji;
    /**
     * ISO 8601 instant when this reaction was created
     * @type {string}
     * @memberof Reaction
     */
    createdTime: string;
 ...
 */
export interface ReactionLinks {
    /**
     * 
     * @type {Link}
     * @memberof ReactionLinks
     */
    self: Link;
    /**
     * 
...
export const ChannelApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {CreateDirectChannelRequest | CreatePublicChannelRequest | CreatePrivateChannelRequest} createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest New channel parameters
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createChannel: async (createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest: CreateDirectChannelRequest | CreatePublicChannelRequest | CreatePrivateChannelRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest' is not null or undefined
            if (createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest === null || createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest === undefined) {
                throw new RequiredError('createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest','Required parameter createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest was null or undefined when calling createChannel.');
            }
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const nonString = typeof createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest !== 'string';
            const needsSerialization = nonString && configuration && configuration.isJsonMime
                ? configuration.isJsonMime(localVarRequestOptions.headers['Content-Type'])
                : nonString;
            localVarRequestOptions.data =  needsSerialization
                ? JSON.stringify(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest !== undefined ? createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest : {})
                : (createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest || "");
         ...
         * @param {string} [username] Searches for messages using the username of user who sent the messages.
         * @param {string} [query] Returns text messages matching the query.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getChannelMessages: async (id: number, start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         * @param {number} [page] 
         * @param {number} [size] 
         * @param {'DIRECT' | 'PUBLIC' | 'PRIVATE'} [type] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getChannels: async (page?: number, size?: number, type?: 'DIRECT' | 'PUBLIC' | 'PRIVATE', options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/channels`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const ChannelApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest: CreateDirectChannelRequest | CreatePublicChannelRequest | CreatePrivateChannelRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Channel>> {
            const localVarAxiosArgs = await ChannelApiAxiosParamCreator(configuration).createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getChannelMessages(id: number, start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagePage>> {
            const localVarAxiosArgs = await ChannelApiAxiosParamCreator(configuration).getChannelMessages(id, start, next, size, relation, username, query, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getChannels(page?: number, size?: number, type?: 'DIRECT' | 'PUBLIC' | 'PRIVATE', options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChannelPage>> {
            const localVarAxiosArgs = await ChannelApiAxiosParamCreator(configuration).getChannels(page, size, type, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ChannelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest: CreateDirectChannelRequest | CreatePublicChannelRequest | CreatePrivateChannelRequest, options?: any): AxiosPromise<Channel> {
            return ChannelApiFp(configuration).createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Adds a user as a group channel member.
         * @summary Create Channel Member
        ...
        getChannelMessages(id: number, start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any): AxiosPromise<MessagePage> {
            return ChannelApiFp(configuration).getChannelMessages(id, start, next, size, relation, username, query, options).then((request) => request(axios, basePath));
        },
        /**
         * Gets a channel page.
         * @summary Get Channel Page
        ...
        getChannels(page?: number, size?: number, type?: 'DIRECT' | 'PUBLIC' | 'PRIVATE', options?: any): AxiosPromise<ChannelPage> {
            return ChannelApiFp(configuration).getChannels(page, size, type, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ChannelApi extends BaseAPI {
     ...
     * @memberof ChannelApi
     */
    public createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest: CreateDirectChannelRequest | CreatePublicChannelRequest | CreatePrivateChannelRequest, options?: any) {
        return ChannelApiFp(this.configuration).createChannel(createDirectChannelRequestCreatePublicChannelRequestCreatePrivateChannelRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ChannelApi
     */
    public getChannelMessages(id: number, start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any) {
        return ChannelApiFp(this.configuration).getChannelMessages(id, start, next, size, relation, username, query, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ChannelApi
     */
    public getChannels(page?: number, size?: number, type?: 'DIRECT' | 'PUBLIC' | 'PRIVATE', options?: any) {
        return ChannelApiFp(this.configuration).getChannels(page, size, type, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MessageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getMessages: async (start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options: any = {}): Promise<RequestArgs> => {
...
export const MessageApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getMessages(start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagePage>> {
            const localVarAxiosArgs = await MessageApiAxiosParamCreator(configuration).getMessages(start, next, size, relation, username, query, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const MessageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getMessages(start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any): AxiosPromise<MessagePage> {
            return MessageApiFp(configuration).getMessages(start, next, size, relation, username, query, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MessageApi extends BaseAPI {
     ...
     * @memberof MessageApi
     */
    public getMessages(start?: number, next?: number, size?: number, relation?: 'SELF' | 'PREVIOUS' | 'NEXT', username?: string, query?: string, options?: any) {
        return MessageApiFp(this.configuration).getMessages(start, next, size, relation, username, query, options).then((request) => request(this.axios, this.basePath));
    }
}
